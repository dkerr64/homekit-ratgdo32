...
* Feature: Save door open/close durations so not reset to unknown on a reboot
* Other: Remove known issues list from prior vesions in CHANGELOG.md... because they are now repeating
